...
INSERT INTO "Cookie Persistenti" ("ID", "Nome Cookie", "Descrizione", "Geolocalizzazione", "Tema", "Data Creazione", "Data Scadenza")
    VALUES
        ('0612105243', 'GYGIA', 'Tecnico usato per autenticazione utente', 'Roma', 'Chiaro', '2023-06-08', '2024-06-08'),
        ('0612104321', 'Audience Studio', 'consente di raccogliere e utilizzare i dati degli utenti delle properties di GEDI Digital, per la creazione di cluster di utenti profilati in base al loro comportamento di navigazione', 'Roma', 'Scuro', '2023-06-08', '2024-06-08'),
        ('0612142632', 'Cools Widget', 'Raccolta di dati personali al fine di fornire agli utenti una piattaforma integrata di shopping.', 'Roma', 'Ambra', '2023-06-08', '2024-03-08'),
        ('0612237482', 'GYGIA', 'Tecnico usato per autenticazione utente', 'Milano', 'Seppia', '2023-01-08', '2024-01-08'),
        ('0612234729', 'Audience Studio', 'consente di raccogliere e utilizzare i dati degli utenti delle properties di GEDI Digital, per la creazione di cluster di utenti profilati in base al loro comportamento di navigazione', 'Milano', 'Monocromo', '2023-01-08', '2024-01-08'),
        ('0612234610', 'Apple Sign In', 'SDK utilizzato per autenticazione utente.', 'Milano', 'Chiaro', '2023-06-08', '2024-06-08'),  
        ('0612320193', 'GYGIA', 'Tecnico usato per autenticazione utente', 'Kentucky', 'Monocromo', '2023-03-08', '2024-03-08'),
        ('0612303948', 'Audience Studio', 'consente di raccogliere e utilizzare i dati degli utenti delle properties di GEDI Digital, per la creazione di cluster di utenti profilati in base al loro comportamento di navigazione', 'Kentucky', 'Monocromo', '2023-03-08', '2024-03-08'),
        ('0612346281', 'Apple Sign In', 'SDK utilizzato per autenticazione utente.', 'Kentucky', 'Scuro', '2023-03-08', '2024-03-08'),
        ('0612426105', 'GYGIA', 'Tecnico usato per autenticazione utente', 'Parigi', 'Alto contrasto', '2023-05-08', '2024-05-08'),
        ('0612424592', 'Audience Studio', 'consente di raccogliere e utilizzare i dati degli utenti delle properties di GEDI Digital, per la creazione di cluster di utenti profilati in base al loro comportamento di navigazione', 'Parigi', 'Scuro', '2023-05-08', '2024-05-08'),
        ('0612414048', 'Google Analytics', 'SDK che permette a GEDI Digital di fruire di un servizio di misurazione ', 'Parigi', 'Seppia', '2023-05-08', '2024-05-08'),
        ('0612504508', 'GYGIA', 'Tecnico usato per autenticazione utente', 'Caserta', 'Scuro', '2023-02-24', '2024-02-24'),
        ('0612500734', 'Audience Studio', 'consente di raccogliere e utilizzare i dati degli utenti delle properties di GEDI Digital, per la creazione di cluster di utenti profilati in base al loro comportamento di navigazione', 'Caserta', 'Chiaro', '2023-02-24', '2024-03-24'),
        ('0612557347', 'Parse', 'SDK utilizzato per l''erogazione di notifiche push aventi finalità editoriali.', 'Caserta', 'Daltonismo', '2023-02-24', '2024-02-24'),
        ('0612675834', 'GYGIA', 'Tecnico usato per autenticazione utente', 'Avellino', 'Chiaro', '2023-05-05', '2024-05-05'),
        ('0612649475', 'Audience Studio', 'consente di raccogliere e utilizzare i dati degli utenti delle properties di GEDI Digital, per la creazione di cluster di utenti profilati in base al loro comportamento di navigazione', 'Avellino', 'Chiaro', '2023-05-05', '2024-05-05'),
        ('0612609574', 'Twipe', 'Raccolta di dati relativi agli utenti al fine di elaborare statistiche relative ai contenuti fruiti dagli utenti e compiere le relative analisi per il miglioramento dei servizi offerti.', 'Avellino', 'Seppia', '2023-05-05', '2024-03-08'),
        ('0612793472', 'GYGIA', 'Tecnico usato per autenticazione utente', 'Torino', 'Seppia', '2023-02-01', '2024-02-01'),
        ('0612720348', 'Audience Studio', 'consente di raccogliere e utilizzare i dati degli utenti delle properties di GEDI Digital, per la creazione di cluster di utenti profilati in base al loro comportamento di navigazione', 'Torino', 'Ambra', '2023-02-01', '2024-02-01'),
        ('0612750437', 'Neodata', 'consente di raccogliere e utilizzare i dati degli utenti delle properties del Gruppo GEDI per la creazione di cluster di utenti profilati in base al loro comportamento di navigazionee', 'Torino', 'Scuro', '2023-02-01', '2024-02-01'),
        ('0612845362', 'GYGIA', 'Tecnico usato per autenticazione utente', 'Aosta', 'Daltonismo', '2023-03-22', '2024-04-22'),
        ('0612820548', 'Audience Studio', 'consente di raccogliere e utilizzare i dati degli utenti delle properties di GEDI Digital, per la creazione di cluster di utenti profilati in base al loro comportamento di navigazione', 'Aosta', 'Monocromo', '2023-03-08', '2024-03-08'),
        ('0612834633', 'Outbrain', 'Erogazione all''utente di una interfaccia grafica, sviluppata e controllata da Outbrain UK Limited, tramite la quale è possibile accedere a contenuti raccomandati', 'Aosta', 'Monocromo', '2023-04-22', '2024-04-22'),
        ('0612945632', 'GYGIA', 'Tecnico usato per autenticazione utente', 'Taranto', 'Scuro', '2023-01-03', '2024-01-03'),
        ('0612923490', 'Audience Studio', 'consente di raccogliere e utilizzare i dati degli utenti delle properties di GEDI Digital, per la creazione di cluster di utenti profilati in base al loro comportamento di navigazione', 'Taranto', 'Scuro', '2023-01-31', '2024-01-31'),
        ('0612945748', 'TWIPE', 'Raccolta di dati relativi agli utenti al fine di elaborare statistiche relative ai contenuti fruiti dagli utenti e compiere le relative analisi per il miglioramento dei servizi offerti.', 'Taranto', 'Scuro', '2023-01-31', '2024-01-31'),  
        ('0613045628', 'GYGIA', 'Tecnico usato per autenticazione utente', 'Granarolo', 'Scuro', '2023-03-18', '2024-03-18'),
        ('0613021534', 'Audience Studio', 'consente di raccogliere e utilizzare i dati degli utenti delle properties di GEDI Digital, per la creazione di cluster di utenti profilati in base al loro comportamento di navigazione', 'Granarolo', 'Chiaro', '2023-03-18', '2024-03-18'),
        ('0613015483', 'Vivocha', 'Creazione di un identificatore univoco della visita dell''utente, che serve per la segnalazione e la creazione di un contatto nel contesto del servizio di interazione con la piattaforma di live chat Vivocha.', 'Granarolo', 'Chiaro', '2023-03-18', '2024-03-18');
...
INSERT INTO "Commento" ("Data Scrittura", "Username Utente", "Ranking", "Testo", "Link Articolo", "Titolo Articolo")
    VALUES
        ...
        ('2023-05-31', 'lisa_brown', 3, 'Non mi ha convinto del tutto.', 'https://www.repubblica.it/alzheimer_test_sangue', 'Alzheimer: test del sangue per capire chi rischia di ammalarsi'),
        ...
        ('2023-06-16', 'sarah_smith', 2, 'Non mi ritrovo con quanto scritto.', 'https://www.gazzetta.it/un-laser-per-ridurre-gli-infortuni', 'Un laser per ridurre gli infortuni'),
        ...
        ('2022-06-21', 'john_doe', 2, 'Non mi ritrovo con quanto scritto.', 'https://www.repubblica.it/elisir_di_lunga_vita_nei_pipistrelli', 'Elisir di lunga vita nei pipistrelli?'),
        ...
        ('2023-06-26', 'olivia_turner', 2, 'Non mi ritrovo con quanto scritto.', 'https://www.gazzetta.it/un-laser-per-ridurre-gli-infortuni', 'Un laser per ridurre gli infortuni'),
        ...
        ('2023-05-28', 'john_doe', 3, 'Mi piacerebbe leggere più approfondimenti su questo tema.','https://www.gazzetta.it/juventus-patteggiamento', 'Juve: come si svolgerà il patteggiamento');
